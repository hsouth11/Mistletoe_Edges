...
#Export
# pdf(here("./figures/prop_odds_1.pdf"), width = 10, height = 7)
# prop_odds_1
# dev.off()
```
...
prop_odds_2b <- 
  ...
  theme_classic() +
  labs(x = "Distance from edge (m)", y = "P(PO) - P(PPO)",
       colour = "DMR") +
  theme(legend.background = element_rect(fill = "lightgrey"),
        legend.key = element_rect(fill = "lightgrey", color = NA),
        legend.title = element_text(size = 20),
...
#Drop the legend from second panel and change the alph level of the points to
#match the first
prop_odds_2b <-  
  ggplot(x5, aes(x=dist_y_h, y = prob_diff, colour = DMR_lev)) + 
  geom_point(alpha = 0.1) +
...
#Export
#Export the graph
# pdf(here("./figures/prop_odds_2.pdf"), width = 11, height = 7)
# prop_odds_2
# dev.off()
```
