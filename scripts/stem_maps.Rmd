...
#Save the plot
##I was struggling to get the legend to behave in this plot. 
##Ended up exporting one that has the panels in a dimensions I liked and 
##another with the legend in appropriate dimensions. Because they are .svgs, 
##I could scale them. 
# tmap_save(p, filename = "./figures/trees_sl_defence_panels.svg",
#           width = 30, height = 8, units = "cm")
# tmap_save(p, filename = "./figures/trees_sl_defence_legend.svg",
#           width = 30, height = 8, units = "cm")
```
